...
public class Lab6 {
    public static void main(String[] args) {
       ...
       do
       {
         ...
         // -->
         System.out.println("Sides: " + shape.getSide1() + " " + shape.getSide2() + " " + shape.getSide3() + " " + shape.getSide4());  
        
         //fill out the code to check for rectangle 
         //utilized if else statements in order to refrain from excessive boolean values being present in code
